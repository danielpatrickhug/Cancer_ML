...
Original file is located at
    https://colab.research.google.com/drive/1kVxNhlPEhe8pux55eu0IPUHNY89l-3I1
...
!mkdir cancernet
# I then Uploaded files from computer including cancernet model and a config.py file and he script to build dataset
